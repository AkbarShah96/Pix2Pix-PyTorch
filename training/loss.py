...
class GANLossD(torch.nn.Module):
    ...
    def __init__(self, gan_mode, target_real_label_upper=1.2,target_real_label_lower=0.8, target_fake_label=0.0):
        ...
        """
        super(GANLossD, self).__init__()
        self.register_buffer('real_label_upper', torch.tensor(target_real_label_upper))
        self.register_buffer('real_label_lower', torch.tensor(target_real_label_lower))
...
class GANLossG(torch.nn.Module):
    """Define different GAN objectives.
